...
class InterestsControler extends Controller
{
    public function getInterests() {
        ...
        $music = [
            "TianTian.png"=> "Tian Tian - Mili", 
            "Pride.png" => "Pride - Kendrick Lamar", 
            "COTC.png" => "Children Of The City - Mili",
            "NaZare.png" => "На заре - Альянс",
        ];
        return view("static.Interests", compact("path", "interests", "music"));
    }
}
